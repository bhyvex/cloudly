...
def server_view(request, hwaddr):
    ...
    SERVICES_COMMON = [
        {'process':"xorg", 'tag':"X11"},
        {'process':"mongod", 'tag':"MongoDB"},
        {'process':"apache", 'tag':"Apache"},        
        {'process':"apache2", 'tag':"Apache"},        
        {'process':"mysqld", 'tag':"MySQLDB"},        
        {'process':"nodejs", 'tag':"Node.js"},        
        {'process':"opentsdb", 'tag':"OpenTSDB"},        
        {'process':"joomla", 'tag':"Joomla"},        
        {'process':"drupal", 'tag':"Drupal 7"},        
        {'process':"ushahidi", 'tag':"Ushahidi"},        
        {'process':"gitlab", 'tag':"GitLab"},        
        {'process':"couchdb", 'tag':"CouchDB"},        
        {'process':"appengine", 'tag':"AppEngine"},        
        {'process':"elgg", 'tag':"Elgg"},        
        {'process':"concrete", 'tag':"Concrete5"},        
        {'process':"e107", 'tag':"e107"},        
        {'process':"collabtive", 'tag':"Collabtive"},        
        {'process':"codeigniter", 'tag':"CodeIgniter"},        
        {'process':"b2evolution", 'tag':"b2evolution"},        
        {'process':"appflower", 'tag':"AppFlower"},        
        {'process':"bambooinvoice", 'tag':"BambooInvoice"},        
        {'process':"mibew", 'tag':"Mibew"},        
        {'process':"canvas", 'tag':"Canvas"},        
        {'process':"cakephp", 'tag':"CakePHP"},        
        {'process':"icescrum", 'tag':"iceScrum"},        
        {'process':"jenkins", 'tag':"Jenkins"},        
        {'process':"lighttpd", 'tag':"Lighttpd"},        
        {'process':"sqlite", 'tag':"SQLite"},        
        {'process':"mambo", 'tag':"Mambo"},        
        {'process':"mahara", 'tag':"Mahara"},        
        {'process':"oscommerce", 'tag':"osCommerce"},        
        {'process':"plone", 'tag':"Plone"},        
        {'process':"limesurvey", 'tag':"LimeSurvey"},        
        {'process':"orangehrm", 'tag':"OrangeHRM"},        
        {'process':"omeka", 'tag':"Omeka"},        
        {'process':"openphoto", 'tag':"OpenPhoto"},        
        {'process':"openldap", 'tag':"OpenLDAP"},        
        {'process':"piwik", 'tag':"Piwik"},        
        {'process':"pligg", 'tag':"Pligg"},        
        {'process':"silverstripe", 'tag':"SilverStripe"},        
