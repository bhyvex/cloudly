...
def server_view(request, hwaddr):
    ...
    SERVICES_COMMON = [
        ...
        {'process':"couchdb", 'tag':"CouchDB", 'description':""},        
        {'process':"appengine", 'tag':"AppEngine", 'description':""},        
        {'process':"elgg", 'tag':"Elgg", 'description':""},        
        {'process':"concrete", 'tag':"Concrete5", 'description':""},        
        {'process':"e107", 'tag':"e107", 'description':""},        
        {'process':"collabtive", 'tag':"Collabtive", 'description':""},        
        {'process':"codeigniter", 'tag':"CodeIgniter", 'description':""},        
        {'process':"b2evolution", 'tag':"b2evolution", 'description':""},        
        {'process':"appflower", 'tag':"AppFlower", 'description':""},        
        {'process':"bambooinvoice", 'tag':"BambooInvoice", 'description':""},        
        {'process':"mibew", 'tag':"Mibew", 'description':""},        
        {'process':"canvas", 'tag':"Canvas", 'description':""},        
        {'process':"cakephp", 'tag':"CakePHP", 'description':""},        
        {'process':"icescrum", 'tag':"iceScrum", 'description':""},        
        {'process':"jenkins", 'tag':"Jenkins", 'description':""},        
        {'process':"lighttpd", 'tag':"Lighttpd", 'description':""},        
        {'process':"sqlite", 'tag':"SQLite", 'description':""},        
        {'process':"mambo", 'tag':"Mambo", 'description':""},        
        {'process':"mahara", 'tag':"Mahara", 'description':""},        
        {'process':"oscommerce", 'tag':"osCommerce", 'description':""},        
        {'process':"plone", 'tag':"Plone", 'description':""},        
        {'process':"limesurvey", 'tag':"LimeSurvey", 'description':""},        
        {'process':"orangehrm", 'tag':"OrangeHRM", 'description':""},        
        {'process':"omeka", 'tag':"Omeka", 'description':""},        
        {'process':"openphoto", 'tag':"OpenPhoto", 'description':""},        
        {'process':"openldap", 'tag':"OpenLDAP", 'description':""},        
        {'process':"piwik", 'tag':"Piwik", 'description':""},        
        {'process':"pligg", 'tag':"Pligg", 'description':""},        
        {'process':"silverstripe", 'tag':"SilverStripe", 'description':""},        
        ...
        {'process':"xoops", 'tag':"XOOPS", 'description':"Content Management and Web Application Platform"},        
        ...
        {'process':"twiki", 'tag':"TWiki", 'description':"Enterprise Wiki Platform"},
        ...
        {'process':"vtiger", 'tag':"vTiger CRM", 'description':"Customer Relationship Management"},
